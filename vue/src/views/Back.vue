...
import {User, Lock, SwitchButton, House, UserFilled, Document, ChatDotSquare, OfficeBuilding, DataAnalysis, Warning, Setting} from '@element-plus/icons-vue'
    ...
    <div class="admin-container">
      ...
      <aside class="admin-sidebar" :style="{ width: sideWidth + 'px'}">
        ...
        >
          ...
          <el-sub-menu index="content" v-if="account.role==='ROLE_ADMIN'">
            <template #title>
              <el-icon><Document /></el-icon>
              <span>内容管理</span>
            </template>

            <el-menu-item index="/back/note">
              <el-icon><Document /></el-icon>
            ...
            <el-menu-item index="/back/club">
              <el-icon><OfficeBuilding /></el-icon>
              <template #title>社团管理</template>
            </el-menu-item>
          </el-sub-menu>

          <el-sub-menu index="user" v-if="account.role==='ROLE_ADMIN'">
            <template #title>
          ...
          <el-menu-item index="/back/statistics" v-if="account.role==='ROLE_ADMIN'">
            <el-icon><DataAnalysis /></el-icon>
